...
// passed to os.Exit.
func RunTests(lang, image, excludeFile string, batchSize, timeout int) int {
...
func getTests(ctx context.Context, d *dockerutil.Container, lang, image string, batchSize, timeout int, excludes map[string]struct{}) ([]testing.InternalTest, error) {
	// Start the container.
